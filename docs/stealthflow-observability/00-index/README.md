...
priority: "highest"
what: "Primary entry point for stealthflow-observability documentation"
why: "Guide AI and developers to project-specific documentation"
how: "Start here to discover all project documentation"
...
**This is the PRIMARY entry point for stealthflow-observability documentation.**

### Discovery Order for AI
...
- [Logging Standard](../../master/03-technical/standards/logging-standard.md) - Reference
- [Testing Standard](../../master/03-technical/standards/testing-standard.md) - Reference
- [Metadata Standard](../../master/08-meta/metadata-standard.md) - Reference
